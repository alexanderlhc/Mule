...
//	protected final static String WORKING_DIR = "src"+File.separator+"resources"+File.separator+"tex"+File.separator;
	 ...
	 */
	public abstract String compileToPDF();
	
	/**
	 * Checks wether LaTeX can be run on local machine
	 * TODO: disallow "RUN" calls if false,
	 * 		also throw error and then show alert from superclass
	...
	public String compileAndMove(String path) {
